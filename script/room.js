...
var Room = {
	...
	Craftables: {
		...
		'polymerisation equipment': {
			...
			button: null,
			maximum: 1,
			availableMsg: _("engineer says bioplastic could be useful. says the settlementrs could make it."),
		...
		'alloyworks': {
			...
			button: null,
			maximum: 1,
			availableMsg: _("engineer says the settlementrs could make alloy, given the tools"),
